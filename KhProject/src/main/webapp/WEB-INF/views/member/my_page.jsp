...
<body>
	...
	<div style="width : 80%; margin : auto; padding : 50px;">
		<form action="http://localhost:8088/kh/update.me" name="signup" id="signUpForm" method="post"
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="http://localhost:8088/kh/delete.me" method="post">
	...
	<div class="modal" id="updatePwd">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="http://localhost:8088/kh/update-pwd.me" method="post">
