...
//			2. 실제 파일을 저장할 물리적인  경로
			...
			// case 2. 기존 첨부파일 O, 새 첨부파일 O => BOARD UPDATE + AT UPDATE
			// case 3. 기존 첨부파일 X, 새 첨부파일 O => BOARD UPDATE + AT INSERT
			
			// DeadLine => 게시글 수정 기능 구현해야지 => 7시에 시작 8시까지는 
			...
			// 1. 기능 만들어야지 => 2. 요구사항분석 => 3. SQL문을 생각 완성 => 4. 코드작성
			// 
